...
def get_output_filename(output_dir: str, model_name: str, mode: str = "naive", num_examples: int = 1000, url_screenshot: bool = False, task: str = "simpleqa") -> str:
    """
    ...
    model_safe = model_name.replace('/', '_').replace(':', '_').replace('-', '_').lower()
